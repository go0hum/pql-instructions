...
export function Home() {
  return (
    <Container>
        ...
        Entre las escobas hay de muy diversa calidad, desde la Barredora 5, pasando por la Nimbus 2000 y Nimbus 2001, hasta llegar a la Saeta de Fuego, escoba prácticamente exclusiva para profesionales y de la que Harry Potter tiene un modelo que le regaló su padrino Sirius Black.
        </p>
        <h2>Las Reglas</h2>
        <p>
        ...
        <ul>
            <li>Los jugadores no pueden salirse de las líneas que limitan el campo de juego, aunque pueden volar tan alto como deseen. La Quaffle se entrega al equipo contrario si algún jugador se sale de los límites.
            </li>
            <li>Los Capitanes pueden pedir tiempo fuera en el momento que lo necesiten. Se puede extender hasta por dos horas si el juego ha durado por más de 12 horas. De no regresar al juego el equipo queda descalificado.
            </li>
            <li>El árbitro puede otorgar penaltis si se comete una falta. Un solo Cazador del equipo agredido vuela desde el círculo central hacia el área de anotación e intenta anotar. El Guardián del equipo contrario puede intentar bloquear el disparo, pero ningún otro jugador debe interferir.
            </li>
            <li>Se permite el contacto, pero los jugadores no pueden sujetar la escoba de otro ni tampoco ninguna parte de su cuerpo. (Draco Malfoy rompe esta regla en El Prisionero de Azkaban sujetando la cola de la escoba de Harry para evitar que atrape la Snitch).
            </li>
            <li>No se permiten sustituciones de jugadores, aún si alguno está muy lastimado para continuar (se hacen excepciones si el juego se prolonga por demasiado tiempo, y los jugadores están demasiado fatigados para continuar).
            </li>
            <li>Los jugadores pueden llevar sus varitas al campo de juego, pero no se pueden usar para hechizar a otros jugadores, al árbitro, las pelotas, o los espectadores. (El derecho de cargar las varitas en el juego fue otorgado durante la cúspide de las persecuciones de magos por parte de los Muggles, de acuerdo con Quidditch A Través de los Tiempos).
            </li>
        </ul>
        </p>
        <h2>El juego</h2>
